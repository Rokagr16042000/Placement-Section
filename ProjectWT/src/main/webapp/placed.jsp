...
<h1>Add placed student</h1><hr>
                        <% if((String)session.getAttribute("message3")!=null)
                        	{
                        %> 
                        <div style="color:red;"><%= (String)session.getAttribute("message3") %></div>
                        <% }%>
...
<input type="submit" value="Add" class="btn btn-dark" ><hr>
</form>
