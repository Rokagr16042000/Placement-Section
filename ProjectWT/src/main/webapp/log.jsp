...
<div class="row">
             ...
             <label style="color:white;">Enter Password:</label><input type="password" name="password"><br><br>
                <% if((String)session.getAttribute("message1")!=null)
                        	{
                        %> 
                        <div style="color:red;"><%= (String)session.getAttribute("message1") %></div>
                        <% }%>
             ...
             <br>
             <hr>
             <h2 style="text-align:center; color: white;">Enter your CPI to fetch companies</h2><br><br>
